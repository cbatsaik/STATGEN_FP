...
To implement this, run the CWBLS() function from the ColliderBias package on your data. It will produce the b value that reflects the true causal associatio
